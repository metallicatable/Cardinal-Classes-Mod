...
namespace fourClassesMod.Content.Prefixes
{
    ...
    public class HereticPrefix : ModPrefix
    {
        ...
        public virtual float LifeMult => 1f; // LIFECOST MUST BE SET IN CARDINALPLAYER AND PREFIX
        ...
        {
            return item.CountsAsClass(ModContent.GetInstance<HereticDamageClass>()) && GetType() != typeof(HereticPrefix);
        }
    ...
    public class DoubleEdged : HereticPrefix
    {
        public override float damageMult => 1.2f;
        public override float LifeMult => 1.2f;

    }

    public class Safe : HereticPrefix
    {
        public override float damageMult => 0.8f;
        public override float LifeMult => 0.75f;
    }

    public class Draining : HereticPrefix
    {
        public override float damageMult => 0.9f;
        public override float useTimeMult => 0.8f;
        public override float LifeMult => 1.3f;
    }

    public class Rending : HereticPrefix
    {
        public override int critBonus => 20;
        public override float useTimeMult => 0.9f;
    }

    public class Visceral : HereticPrefix
    {
        public override float damageMult => 1.1f;
        public override float useTimeMult => 0.95f;
        public override int critBonus => 15;
        public override float LifeMult => 0.85f;
    }

    public class Painful : HereticPrefix
    {
        public override float LifeMult => 1.3f;
    }
