...
{
    public class BarbarianDamageClass : DamageClass
    {
        // This is an Cultist damage class designed to demonstrate all the current functionality of the feature and explain how to create one of your own, should you need one.
        // For information about how to apply stat bonuses to specific damage classes, please instead refer to CultistMod/Content/Items/Accessories/CultistStatBonusAccessory.
        public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
        {
            ...
            // For Cultist, if we propose a hypothetical alternate return for DamageClass.Ranged...
            /*
        ...
        public override bool GetEffectInheritance(DamageClass damageClass)
        {
            ...
            // For this Cultist, we'll make our class able to activate melee- and magic-specifically effects.
            /*
        ...
        {
            // This method lets you set default statistical modifiers for your Cultist damage class.
            // Here, we'll make our Cultist damage class have more critical strike chance and armor penetration than normal.
            player.GetCritChance<CultistDamageClass>() += 4;
            player.GetArmorPenetration<CultistDamageClass>() += 10;
            // These sorts of modifiers also exist for damage (GetDamage), knockback (GetKnockback), and attack speed (GetAttackSpeed).
            // You'll see these used all around in reference to vanilla classes and our Cultist class here. Familiarize yourself with them.
        }
        */
